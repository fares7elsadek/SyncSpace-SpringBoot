package com.fares7elsadek.syncspace.notification.controller;

import com.fares7elsadek.syncspace.notification.commands.markall.MarkAllAsReadCommand;
import com.fares7elsadek.syncspace.notification.commands.markread.MarkReadCommand;
import com.fares7elsadek.syncspace.notification.commands.removenotification.RemoveNotificationCommand;
import com.fares7elsadek.syncspace.notification.model.dtos.NotificationDto;
import com.fares7elsadek.syncspace.notification.queries.getall.GetAllNotificationsQuery;
import com.fares7elsadek.syncspace.notification.queries.getunread.GetAllUnReadNotificationsQuery;
